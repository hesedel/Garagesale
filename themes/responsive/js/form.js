...
$('div.input-text, div.textarea').bind('click', function() {
	$('input[type=text], input[type=email], input[type=number], input[type=password], textarea', $(this)).trigger('focus');
});

$('input[type=text], input[type=email], input[type=number], input[type=password], textarea', 'div.input-text, div.textarea').each(function() {
	$(this)
