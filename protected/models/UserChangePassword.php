...
/**
 * This is the model class for table "user_changePassword".
 *
 * The followings are the available columns in table 'user_changePassword':
 * @property string $id
...
class UserChangePassword extends CActiveRecord
{
	 ...
	 * @return UserChangePassword the static model class
	 */
